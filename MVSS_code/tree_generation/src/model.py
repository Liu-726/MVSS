...
class APIModel:
    ...
    def chat_complete(self, messages, temperature=0, max_tokens=None):
        """
        模拟 OpenAI Chat Completions API 风格
        :param messages: list of dict, e.g. [{"role": "user", "content": "Hello"}]
        :param temperature: float
        :param max_tokens: int or None
        """
        url = f"{self.__api_url}"
